...
import net.modelbased.sensapp.library.system.{URLHandler, HttpSpraySupport}
import cc.spray.client.{Put, HttpConduit}
...
class HttpProtocol extends AbstractProtocol with HttpSpraySupport{
  ...
  def send(subscription: Option[Subscription], root: Root, sensor: String){
