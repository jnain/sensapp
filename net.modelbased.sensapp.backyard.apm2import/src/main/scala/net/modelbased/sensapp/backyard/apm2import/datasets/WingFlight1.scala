...
object WingFlight1 {
  ...
  def main(args : Array[String]) {
    ...
    APMDataParser.writeSenML(out_folder + "raw/" + name + "_1hz.json", data1hz, name , 1338056580)

    APMDataParser.writeIndividualSenML(out_folder + "data/" + name + "_1hz", data1hz, name , 1338056580);
